!function(){
  ...
  function e(e){
    ...
    for(i=e.length;i;i-=1)
      n=Math.floor(Math.random()*i),t=e[i-1],e[i-1]=e[n],e[n]=t;
    return e
  }
  ...
  window.requestTimeout=function(e,n) {
    function t() {
      var o=(new Date).getTime(),r=o-i;r>=n?e.call():a.value=window.requestAnimFrame(t)
    } 
    if(!(window.requestAnimationFrame||
         window.webkitRequestAnimationFrame||
         window.mozRequestAnimationFrame&&window.mozCancelRequestAnimationFrame||
        ...
        a.classList.add("hamburger--"+i[e]),window.requestTimeout(function(){
          a.classList.add("is-active"),window.requestTimeout(function(){
            a.classList.remove("is-active"),window.requestTimeout(function(){
              ...
              var n=e+1;n===i.length&&(n=1),a.setAttribute("data-class",n)
            },750)
          },1e3)
        },750)
      }
